---
title: "The \"Is AI Wrong?\" Checklist"
description: "Spot when AI is confidently bluffing - weak zones, behavioral red flags, and a 60-second verify routine."
pillar: "Judgment"
order: 1
---
...
1. **Ask for the source** — "What's your source? Link it." (Then actually look.)
2. **Confirm the source is real** and says what the AI claims. Click the link: does it exist? Does it say that?
3. **Check one hard fact** — the riskiest number, name, or claim — against a primary source (the original site, a report, your own records).
4. **If it matters, cross-check** a second way — a fresh chat, a different tool, or "what would someone who disagrees say?"
